...
const SERIAL: i32 = 3;
// Fork-specific constant (not in upstream). PASSWORD_ENC_VERSION and ENCRYPT_MAX_LEN
// are now imported from the permanent_password module (upstream password-hash
// refactor #507), so they must NOT be redefined locally here.
